        ...
        <div class="bg-white rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 mb-10">
                    ...
                    <div v-if="showSuccessModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
                      <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-xs relative">
                        <button class="absolute top-2 right-2 text-gray-500 hover:text-yellow-500" @click="closeSuccessModal">✕</button>
                        <h3 class="text-xl font-bold mb-4 text-center text-yellow-700">บันทึกข้อมูลสำเร็จ</h3>
                        <div class="flex flex-col items-center mb-4">
                          <span class="mb-2 text-gray-700">ข้อมูลหมวดหมู่ถูกบันทึกเรียบร้อยแล้ว</span>
                          <span class="inline-block w-8 h-8 border-4 border-yellow-400 border-t-transparent rounded-full animate-spin"></span>
